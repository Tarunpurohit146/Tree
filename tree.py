...
if __name__=="__main__":
    ...
    parse.add_argument("-b","--basic",metavar="directry_name",help="show's basic structure of directory")
    parse.add_argument("-a","--advance",metavar="directry_name",help="show's addir_list1ance structure of directory")
    parse.add_argument("-f","--file",metavar="file_name",help="find file in the directory")
    parse.add_argument("-d","--directory",metavar="directory_name",help="find sub directory in the directory")
    parse.add_argument("-e",metavar="directory_name",help="Segregate file based on Extenstion")
    parse.add_argument("-m",metavar="file_name",help="Shows meta data of file")
